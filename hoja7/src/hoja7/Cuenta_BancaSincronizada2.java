...
/**Fichero Cuenta_BancaSincronizada2.java
 ...
 * 
 */
public class Cuenta_BancaSincronizada2 extends Thread
{
     ...
     public Cuenta_BancaSincronizada2(){} //constructor nulo

     public Cuenta_BancaSincronizada2(int id, double disponible, String propietario)
     {
	Codigo_Cuenta=id;
