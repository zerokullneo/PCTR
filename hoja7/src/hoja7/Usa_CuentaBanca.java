 ...
 * 
 */
public class Usa_CuentaBanca
{
     public static void main (String [] args)
     {
	Cuenta_BancaSincronizada Antonio;
	Cuenta_BancaSincronizada Juan = new Cuenta_BancaSincronizada(32756821, 100000);
	...
	Antonio = new Cuenta_BancaSincronizada(45073256, 25000);
