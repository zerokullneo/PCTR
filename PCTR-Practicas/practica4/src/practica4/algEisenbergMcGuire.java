...
/**Descripcion
 * Clase que realiza la propuesta de solucion de la Exclusion Mutua de los
 * matematicos Eisenberg y McGuire.
 */
public class algEisenbergMcGuire implements Runnable
{
	/**
	 * Variable de estados que pueden adoptar cada proceso en un instante
	 * determinado.
	 */
	private enum pstate{IDLE, WAITING, ACTIVE};
	/**
	 * Array que simula la peticion de acceso de cada proceso a la
	 * seccion critica.
	 */
	private pstate []flags;
	/**
	 * Variables de control de acceso a la seccion critica.
	 */
	private static int turn, index, i;
	/**
	...
	/**
	 * Constructor base que inicializa los estados de los procesos a IDLE.
	 * @param t Variable de turno que controla el acceso
	 * @param num Variable compartida que puede tener un estado inicial 0
	 * o mayor que 0.
	 */
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		EM1.join();
		EM2.join();
		System.out.println("Valor de variable compartida: " + index);
	}
}
