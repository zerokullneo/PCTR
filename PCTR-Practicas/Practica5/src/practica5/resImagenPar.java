...
/**Descripcion
 * Clase que realiza el resaltado de una imagen de forma paralela con el 
 * interfaz Runnable.
 */
public class resImagenPar extends CargaImagen implements Runnable
{

	private final int n;
	private final int m;
     private final int parte;
     private final int tampool;
      ...
      * @throws IOException 
      */
     public resImagenPar(int p,int tpl)throws IOException
     {
          parte = p;
		n = matriz.length;
		m = matriz.length;
      ...
      * @return Devuelve la dimension de la matriz.
      */
      ...
      */
     public resImagenPar vectorizar(resImagenPar img, int i, int in)
	...
	@Override
     ...
     public static void main(String[] args) throws IOException
     {
		...
		LinkedList<resImagenPar> tareas = new LinkedList<resImagenPar>();
		...
		for(i=0;i < tamPool;i++)
			tareas.add(new resImagenPar(i,tamPool));
