...
/**Fichero intParalelauniCont.java
...
public class intParalelauniCont implements Runnable
{
     ...
     public intParalelauniCont(int tampool,double cx,double cy)
     {
	intParalelauniCont.cx=cx;
	intParalelauniCont.cy=cy;
     }
	...
	for(int i=0; i<tampool; i++)
	     new Thread(new intParalelauniCont(tampool,(int)cx,(int)cy)).start();
     }
}
