...
/**Fichero intParalelomultiCont.java
...
public class intParalelomultiCont implements Runnable
{
     ...
     public intParalelomultiCont(int tampool,double cx,double cy)
     {
	this.cx=cx;
	this.cy=cy;
     }
	...
	for(int i=0; i<tampool; i++)
	     new Thread(new intParalelomultiCont(tampool,(int)cx,(int)cy)).start();
     }
}
