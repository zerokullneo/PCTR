...
/**Fichero piMonteCarloMulti.java
 ...
 * 
 */
public class piMonteCarloMulti implements Runnable
{
     ...
     public piMonteCarloMulti(int tampool,double cx,double cy)
     {
	this.cx=cx;
	this.cy=cy;
     }
	...
	for(int i=0; i<tampool; i++)
	     new Thread(new piMonteCarloMulti(tampool,(int)cx,(int)cy)).start();
     }
}
