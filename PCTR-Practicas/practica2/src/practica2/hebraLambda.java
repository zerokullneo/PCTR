...
public class hebraLambda
{
	 ...
	 */
	private static int limiteI = 500000;
	/**
	 * Límite del Hilo Decremental.
	 */
	private static int limiteH = 1000000;

	public static void main (String[] args) throws Exception
	{
		Thread []hebra = new Thread[limiteH];
		Thread []thread = new Thread[limiteI];
