...
/**Descripcion
 * Clase que crea un servidor para peticiones de clientes de forma concurrente.
 */
public class ServidorHiloconPool implements Runnable
{
	/**
	 * Variable de comunicacion entre cliente/servidor.
	 */
	Socket enchufe;

	/**
	 * Constructor base de la clase ServidorHiloconPool.
	 * @param s socket previamente creado y abierto.
	 */
	...
	/**
	 * Metodo run sobreescrito para recibir varias peticiones simultaneas.
	 */
